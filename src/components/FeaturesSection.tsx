...
const FeaturesSection: React.FC = () => {
  const features = [
    ...
    },
    {
      ...
      description: 'Future Feature: Browse curated opportunities, schedule bite-sized coffee chats, and connect in a safe community forum.',
      ...
      link: '/networking', // This will navigate to the new page
    },
    {
